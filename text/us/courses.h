COURSE_ACTS(COURSE_BOB, _(" 1 RUN AND PUNCH"),
       _("REACH THE SUMMIT")     , _("RED COIN CHALLENGE") , _("SHOOT TO THE ISLAND IN THE SKY"),
       _("FIND THE 8 RED COINS")          , _("MARIO WINGS TO THE SKY")        , _("BEHIND CHAIN CHOMP'S GATE"))

COURSE_ACTS(COURSE_WF, _(" 2 BOSS FIGHT"),
       _("KING BOB OMB")        , _("KING BOB OMB")    , _("SHOOT INTO THE WILD BLUE"),
       _("RED COINS ON THE FLOATING ISLE"), _("FALL ONTO THE CAGED ISLAND")    , _("BLAST AWAY THE WALL"))

COURSE_ACTS(COURSE_JRB, _(" 3 JUMP AND DASH"),
       _("INVADE THE FORTESS")    , _("CAN THE EEL COME OUT TO PLAY?") , _("TREASURE OF THE OCEAN CAVE"),
       _("RED COINS ON THE SHIP AFLOAT")  , _("BLAST TO THE STONE PILLAR")     , _("THROUGH THE JET STREAM"))

COURSE_ACTS(COURSE_CCM, _(" 3 BOSS FIGHT"),
       _("KING WHOMP")             , _("LI'L PENGUIN LOST")             , _("BIG PENGUIN RACE"),
...
SECRET_STAR(COURSE_TOTWC, _("   KAMEK'S TOWER"))
