COURSE_ACTS(COURSE_BOB, _(" 1 SAW BLADE HOP"),
       _("WALLKICKS WILL WORK")     , _("FOOTRACE WITH KOOPA THE QUICK") , _("SHOOT TO THE ISLAND IN THE SKY"),
       _("FIND THE 8 RED COINS")          , _("KOOP WINGS TO THE SKY")        , _("BEHIND CHAIN CHOMP'S GATE"))
...
COURSE_ACTS(COURSE_HMC, _(" 6 HAZY MAZE CAVE"),
       _("SWIMMING BEAST IN THE CAVERN")  , _("ELEVATE FOR 8 RED COINS")       , _("METAL-HEAD KOOP CAN MOVE!"),
...
COURSE_ACTS(COURSE_TUTORIAL, _("   SHRED TUTORIAL"),
       _("GET THE STAR")  , _("")      , _(""),
       _("")        , _("")             , _(""))
...
SECRET_STAR(COURSE_WMOTR, _("   WING KOOP OVER THE RAINBOW"))
