...
COURSE_ACTS(COURSE_JRB, _(" 3 CROSSOVERS"),
       _("CROSSOVERS-REGULAR")    , _("CAN THE EEL COME OUT TO PLAY?") , _("TREASURE OF THE OCEAN CAVE"),
       _("RED COINS ON THE SHIP AFLOAT")  , _("BLAST TO THE STONE PILLAR")     , _("THROUGH THE JET STREAM"))

COURSE_ACTS(COURSE_CCM, _(" 3 CROSSOVERS"),
       _("CROSSOVERS-SIMPLE")             , _("LI'L PENGUIN LOST")             , _("BIG PENGUIN RACE"),
