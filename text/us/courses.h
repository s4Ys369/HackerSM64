COURSE_ACTS(COURSE_BOB, _(" 1 SOMEWHERE"),
       _("RISE")     , _("FOOTRACE WITH KOOPA THE QUICK") , _("SHOOT TO THE ISLAND IN THE SKY"),
       _("FIND THE 8 RED COINS")          , _("MARIO WINGS TO THE SKY")        , _("BEHIND CHAIN CHOMP'S GATE"))

COURSE_ACTS(COURSE_WF, _(" 2 SOMEWHERE ELSE"),
       _("CHIPPED OFF WHOMP")        , _("TO THE TOP OF THE FORTRESS")    , _("SHOOT INTO THE WILD BLUE"),
       _("RED COINS ON THE FLOATING ISLE"), _("FALL ONTO THE CAGED ISLAND")    , _("BLAST AWAY THE WALL"))

COURSE_ACTS(COURSE_JRB, _(" 3 THAT'S IT"),
...
COURSE_ACTS(COURSE_CCM, _(" 4 PROMISE"),
...
COURSE_ACTS(COURSE_BBH, _(" 5 NO MORE LEVELS"),
...
COURSE_ACTS(COURSE_HMC, _(" 6 PLEASE STOP"),
...
COURSE_ACTS(COURSE_LLL, _(" 7 WHY ARE YOU"),
...
COURSE_ACTS(COURSE_SSL, _(" 8 LIKE THIS"),
...
COURSE_ACTS(COURSE_DDD, _(" 9 WHO HURT YOU"),
...
COURSE_ACTS(COURSE_SL, _("10 WANNA HUG"),
...
COURSE_ACTS(COURSE_WDW, _("11 NO"),
...
COURSE_ACTS(COURSE_TTM, _("12 WELL YEAH"),
...
COURSE_ACTS(COURSE_THI, _("13 THAT WOULD BE"),
...
COURSE_ACTS(COURSE_TTC, _("14 KINDA WEIRD"),
...
COURSE_ACTS(COURSE_RR, _("15 IF WE LIKE IT"),
