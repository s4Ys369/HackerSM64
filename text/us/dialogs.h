...
DEFINE_DIALOG(DIALOG_170, SOUND_OBJ_BOBOMB_BUDDY_TALK, 4, 30, 200, "\
Welcome to\n\
Koop Gets the Stomp\n\
Vanilla Edition!\n\
\n\
...
DEFINE_DIALOG(DIALOG_171, SOUND_OBJ_BOBOMB_BUDDY_TALK, 4, 30, 200, "\
While Shredding,\n\
Press B to boost\n\
and hold Z to\n\
...
DEFINE_DIALOG(DIALOG_172, SOUND_OBJ_BOBOMB_BUDDY_TALK, 4, 30, 200, "\
Koop automatically\n\
grabs his shell\n\
while shredding\n\
underwater.\n\
