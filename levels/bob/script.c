...
const LevelScript level_bob_entry[] = {
	...
	AREA(1, bob_area_1),
		...
		OBJECT(MODEL_SAW_BLADE, 1400, 5200, -470, 0, 0, 0, 0x00EC0000, bhvSawBlade),
		OBJECT(MODEL_SAW_BLADE, 1650, 5200, 480, 0, 0, 0, 0x00EC0000, bhvSawBlade),
		OBJECT(MODEL_NONE, -3000, 5200, -470, 0, 0, 0, 0x00000000, bhvSawBladeWayPoint),
