...
const LevelScript level_bob_entry[] = {
	...
	AREA(1, bob_area_1),
		...
		OBJECT(MODEL_SAW_BLADE, 1400, 450, 350, 0, 0, 0, (0xEC << 16), bhvSawBlade),
		OBJECT(MODEL_SAW_BLADE, 2600, 650, -700, 0, 0, 0, (0xEC << 16), bhvSawBlade),
		OBJECT(MODEL_SAW_BLADE, 2600, 650, 700, 0, 0, 0, (0xEC << 16), bhvSawBlade),
		OBJECT(MODEL_SAW_BLADE, 3200, 850, 0, 0, 0, 0, (0xEC << 16), bhvSawBlade),
		OBJECT(MODEL_SAW_BLADE, 4000, 1250, -700, 0, 0, 0, (0xEC << 16), bhvSawBlade),
		OBJECT(MODEL_SAW_BLADE, 4000, 1250, 700, 0, 0, 0, (0xEC << 16), bhvSawBlade),
		OBJECT(MODEL_SAW_BLADE, 4600, 1450, 0, 0, 0, 0, (0xEC << 16), bhvSawBlade),
