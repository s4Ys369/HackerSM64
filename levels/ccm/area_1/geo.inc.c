...
const GeoLayout ccm_area_1_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, 28, 800, -37, 0, 23, 0, ccm_dl_base_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 28, -485, -37, ccm_dl_castle_mesh_layer_1),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
