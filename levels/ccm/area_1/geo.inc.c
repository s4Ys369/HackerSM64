...
const GeoLayout ccm_area_1_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 28, 484, -896, ccm_dl_Cube_002_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 28, -247, -37, ccm_dl_Cylinder_001_mesh_layer_1),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
