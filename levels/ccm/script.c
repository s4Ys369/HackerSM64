...
const LevelScript level_ccm_entry[] = {
	...
	AREA(1, ccm_area_1),
		...
		WARP_NODE(0x0B, LEVEL_CCM, 0x01, 0x0B, WARP_CHECKPOINT),
		WARP_NODE(0xF0, LEVEL_TOTWC, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0xF1, LEVEL_CCM, 0x01, 0x0B, WARP_CHECKPOINT),
		...
		OBJECT(MODEL_NONE, 0, 2000, 285, 0, 0, 0, 0x000B0000, bhvSpinAirborneWarp),
