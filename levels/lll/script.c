...
static const LevelScript script_lll_area_1_macro_objects[] = {
    ...
    OBJECT(/*model*/ MODEL_NONE,            /*pos*/  1400,   -20,  3720, /*angle*/ 0,   0, 0, /*behParam*/ (FLAMETHROWER_BP_UPWARDS << 16)\(0x01), /*beh*/ bhvFlamethrower),
    OBJECT(/*model*/ MODEL_NONE,            /*pos*/  7100,   -20,  3420, /*angle*/ 0,   0, 0, /*behParam*/ (FLAMETHROWER_BP_UPWARDS << 16)\(0x01), /*beh*/ bhvFlamethrower),
    OBJECT(/*model*/ MODEL_NONE,            /*pos*/  7300,   -20,  5160, /*angle*/ 0,   0, 0, /*behParam*/ (FLAMETHROWER_BP_UPWARDS << 16)\(0x01), /*beh*/ bhvFlamethrower),
    OBJECT(/*model*/ MODEL_NONE,            /*pos*/  7100,   -20,  5700, /*angle*/ 0,   0, 0, /*behParam*/ (FLAMETHROWER_BP_UPWARDS << 16)\(0x01), /*beh*/ bhvFlamethrower),
...
static const LevelScript script_lll_area_1_objects_4[] = {
    ...
    OBJECT(/*model*/ MODEL_NONE,            /*pos*/     0,  950, -6800, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvDefaultStarMarker),
    OBJECT(/*model*/ MODEL_NONE,            /*pos*/     0,  154, -5631, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvBigBullyBridge),
    OBJECT(/*model*/ MODEL_BULLY_BOSS,      /*pos*/  4046, 2234, -5521, /*angle*/ 0,   0, 0, /*behParam*/ 0x01000000, /*beh*/ bhvBigBullyWithMinions),
    OBJECT(/*model*/ MODEL_NONE,            /*pos*/  3700,  600, -5500, /*angle*/ 0,   0, 0, /*behParam*/ 0x01000000, /*beh*/ bhvDefaultStarMarker),
    OBJECT(/*model*/ MODEL_NONE,            /*pos*/  4454,  307, -5426, /*angle*/ 0,   0, 0, /*behParam*/ (BIG_BULLY_MINION_1 << 24), /*beh*/ bhvBigBullyMinion),
    OBJECT(/*model*/ MODEL_NONE,            /*pos*/  3840,  307, -6041, /*angle*/ 0,   0, 0, /*behParam*/ (BIG_BULLY_MINION_2 << 24), /*beh*/ bhvBigBullyMinion),
    OBJECT(/*model*/ MODEL_NONE,            /*pos*/  3226,  307, -5426, /*angle*/ 0,   0, 0, /*behParam*/ (BIG_BULLY_MINION_3 << 24), /*beh*/ bhvBigBullyMinion),
    ...
    OBJECT(/*model*/ MODEL_NONE,            /*pos*/     0,  200, -2048, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000001, /*beh*/ bhvFlamethrower),
...
static const LevelScript script_lll_area_2_objects_1[] = {
    ...
    OBJECT(/*model*/ MODEL_NONE,                         /*pos*/  2943,  476,    10, /*angle*/ 0, 270, 0, /*behParam*/ 0x00020001, /*beh*/ bhvFlamethrower),
    OBJECT(/*model*/ MODEL_NONE,                         /*pos*/ -2759, 2350, -1108, /*angle*/ 0,  60, 0, /*behParam*/ 0x00020001, /*beh*/ bhvFlamethrower),
    OBJECT(/*model*/ MODEL_NONE,                         /*pos*/ -2472, 2350, -1605, /*angle*/ 0,  60, 0, /*behParam*/ 0x00020001, /*beh*/ bhvFlamethrower),
