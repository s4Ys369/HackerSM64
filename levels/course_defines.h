...
DEFINE_COURSE(COURSE_BOB, 0x40444440) // (1)  Bob Omb Battlefield
DEFINE_COURSE(COURSE_WF, 0x00444440) // (2)  Whomp's Fortress
DEFINE_COURSE(COURSE_JRB, 0x00444440) // (3)  Jolly Rodger's Bay
DEFINE_COURSE(COURSE_CCM, 0x00444440) // (4)  Cool Cool Mountain
...
DEFINE_BONUS_COURSE(COURSE_TOTWC, 0x00444440) // (21) Tower of the Wing Cap
