...
const GeoLayout mario_fludd_arm[] = {
	GEO_TRANSLATE_ROTATE(LAYER_OPAQUE, 68, 0, 0, 0, 0, 0),
	GEO_OPEN_NODE(),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, mario_switch_dl_mesh_layer_1),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
...
const GeoLayout mario_002_switch_opt0_001_switch_opt1_jump_mario_fludd_arm[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_ROTATE(LAYER_OPAQUE, 68, 0, 0, 0, 0, 0),
		GEO_OPEN_NODE(),
			GEO_DISPLAY_LIST(LAYER_TRANSPARENT, mario_switch_dl_mesh_layer_1),
		GEO_CLOSE_NODE(),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
		...
		GEO_OPEN_NODE(),
			...
			GEO_OPEN_NODE(),
				...
				GEO_OPEN_NODE(),
					...
					GEO_CLOSE_NODE(),
				GEO_CLOSE_NODE(),
				GEO_SWITCH_CASE(0, geo_switch_torso),
				GEO_OPEN_NODE(),
					GEO_NODE_START(),
					GEO_OPEN_NODE(),
					GEO_CLOSE_NODE(),
					GEO_BRANCH(1, mario_002_switch_opt0_001_switch_opt1_jump_mario_fludd_arm),
				GEO_CLOSE_NODE(),
			GEO_CLOSE_NODE(),
		GEO_CLOSE_NODE(),
	GEO_CLOSE_NODE(),
...
const GeoLayout mario_002_switch_opt0_001_switch_opt2_jump_mario_fludd_arm[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_ROTATE(LAYER_OPAQUE, 68, 0, 0, 0, 0, 0),
		GEO_OPEN_NODE(),
			GEO_DISPLAY_LIST(LAYER_OPAQUE, mario_switch_dl_mesh_layer_1_mat_override_metal_v3_001_0),
		GEO_CLOSE_NODE(),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
		...
		GEO_OPEN_NODE(),
			...
			GEO_OPEN_NODE(),
				...
				GEO_OPEN_NODE(),
					...
					GEO_OPEN_NODE(),
					GEO_CLOSE_NODE(),
					GEO_BRANCH(1, mario_002_switch_opt0_001_switch_opt2_jump_mario_fludd_arm),
				GEO_CLOSE_NODE(),
			GEO_CLOSE_NODE(),
		GEO_CLOSE_NODE(),
	GEO_CLOSE_NODE(),
...
const GeoLayout mario_002_switch_opt0_001_switch_opt3_jump_mario_fludd_arm[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_ROTATE(LAYER_OPAQUE, 68, 0, 0, 0, 0, 0),
		GEO_OPEN_NODE(),
			GEO_DISPLAY_LIST(LAYER_TRANSPARENT, mario_switch_dl_mesh_layer_1_mat_override_metal_v3_001_0),
		GEO_CLOSE_NODE(),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
		...
		GEO_OPEN_NODE(),
			...
			GEO_OPEN_NODE(),
				...
				GEO_OPEN_NODE(),
					...
					GEO_OPEN_NODE(),
					GEO_CLOSE_NODE(),
					GEO_BRANCH(1, mario_002_switch_opt0_001_switch_opt3_jump_mario_fludd_arm),
				GEO_CLOSE_NODE(),
			GEO_CLOSE_NODE(),
		GEO_CLOSE_NODE(),
	GEO_CLOSE_NODE(),
